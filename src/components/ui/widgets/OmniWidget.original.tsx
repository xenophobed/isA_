/**
 * ============================================================================
 * Omni Widget UI (OmniWidget.tsx) - Exact replica of omni_sidebar.tsx interface
 * ============================================================================
 * 
 * 【核心职责】
 * - 纯UI组件，完全复制omni_sidebar.tsx的界面设计
 * - 多主题内容生成系统（10个主题类别）
 * - 智能模板选择和深度配置
 * - 参考资料管理（URLs、文件、文本）
 * - 不包含业务逻辑，只负责UI展示
 * 
 * 【数据流向】
 * OmniWidgetModule → OmniWidget UI → 用户交互事件 → OmniWidgetModule
 */
...
/**
 * Omni Widget UI - Exact replica of omni_sidebar content generation interface
 */
