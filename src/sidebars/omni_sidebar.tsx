...
Begin your scientific analysis now.`
  ...
  // Topic Categories for UI (all 10 categories + custom)
  ...
  // Generate topic-specific prompt template
      ...
      await onProcess(prompt, {
        template_parameters: {
          ...
          prompt_args: {
            ...
            reference_files: args.referenceFiles.map(f => f.name),
            capabilities_needed: [
              'web_search',
              'url_crawling', 
              'data_analysis',
        ...
        metadata: {
          ...
          references_used: args.referenceUrls.length + (args.referenceText ? 1 : 0),
