...
/**
 * Test component for debugging Omni streaming issues
 */
export const TestOmniStream: React.FC = () => {
  ...
  const handleTest = async () => {
    ...
    addLog('Starting Omni test request...');
    ...
    try {
      const requestMetadata = {
        ...
        template_parameters: {
          app_id: "omni",
          template_id: "business_market_analysis_prompt",
          prompt_args: {
            topic: "business",
            template: "market_analysis", 
            subject: "aripod market analysis report",
            depth: "deep",
            capabilities_needed: ['web_search', 'url_crawling', 'data_analysis']
          }
        },
        ...
        metadata: {
          sender: 'omni-app',
          app: 'omni',
          requestType: 'topic_content_generation'
        }
      };
      ...
      const messageId = await client.sendMessage(
        'You are a market research analyst. Create comprehensive market analysis about "aripod market analysis report". Provide deep analysis with market trends, competitive landscape, and strategic recommendations.',
        requestMetadata
      );
  ...
  return (
    <div className="p-6 bg-gray-900 text-white h-screen overflow-hidden">
      <h1 className="text-2xl font-bold mb-4">Test: Omni Stream</h1>
